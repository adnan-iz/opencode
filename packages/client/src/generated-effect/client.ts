...
const Endpoint9_0 = (raw: RawClient["server.global-credential"]) => () =>
  raw["global-credential.list"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint9_1Request = Parameters<RawClient["server.global-credential"]["global-credential.create"]>[0]
type Endpoint9_1Input = {
  readonly label: Endpoint9_1Request["payload"]["label"]
  readonly type: Endpoint9_1Request["payload"]["type"]
  readonly value: Endpoint9_1Request["payload"]["value"]
  readonly tags?: Endpoint9_1Request["payload"]["tags"]
}
const Endpoint9_1 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_1Input) =>
  raw["global-credential.create"]({
    payload: { label: input["label"], type: input["type"], value: input["value"], tags: input["tags"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_2Request = Parameters<RawClient["server.global-credential"]["global-credential.get"]>[0]
type Endpoint9_2Input = { readonly id: Endpoint9_2Request["params"]["id"] }
const Endpoint9_2 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_2Input) =>
  raw["global-credential.get"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_3Request = Parameters<RawClient["server.global-credential"]["global-credential.update"]>[0]
type Endpoint9_3Input = {
  readonly id: Endpoint9_3Request["params"]["id"]
  readonly label?: Endpoint9_3Request["payload"]["label"]
  readonly value?: Endpoint9_3Request["payload"]["value"]
  readonly tags?: Endpoint9_3Request["payload"]["tags"]
}
const Endpoint9_3 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_3Input) =>
  raw["global-credential.update"]({
    params: { id: input["id"] },
    payload: { label: input["label"], value: input["value"], tags: input["tags"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_4Request = Parameters<RawClient["server.global-credential"]["global-credential.remove"]>[0]
type Endpoint9_4Input = { readonly id: Endpoint9_4Request["params"]["id"] }
const Endpoint9_4 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_4Input) =>
  raw["global-credential.remove"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_5Request = Parameters<RawClient["server.global-credential"]["global-credential.link"]>[0]
type Endpoint9_5Input = {
  readonly id: Endpoint9_5Request["params"]["id"]
  readonly project_path: Endpoint9_5Request["payload"]["project_path"]
  readonly env_mapping?: Endpoint9_5Request["payload"]["env_mapping"]
}
const Endpoint9_5 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_5Input) =>
  raw["global-credential.link"]({
    params: { id: input["id"] },
    payload: { project_path: input["project_path"], env_mapping: input["env_mapping"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_6Request = Parameters<RawClient["server.global-credential"]["global-credential.unlink"]>[0]
type Endpoint9_6Input = {
  readonly id: Endpoint9_6Request["params"]["id"]
  readonly project: Endpoint9_6Request["params"]["project"]
}
const Endpoint9_6 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_6Input) =>
  raw["global-credential.unlink"]({ params: { id: input["id"], project: input["project"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint9_7Request = Parameters<RawClient["server.global-credential"]["global-credential.resolve"]>[0]
type Endpoint9_7Input = { readonly project: Endpoint9_7Request["params"]["project"] }
const Endpoint9_7 = (raw: RawClient["server.global-credential"]) => (input: Endpoint9_7Input) =>
  raw["global-credential.resolve"]({ params: { project: input["project"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup9 = (raw: RawClient["server.global-credential"]) => ({
  list: Endpoint9_0(raw),
  create: Endpoint9_1(raw),
  get: Endpoint9_2(raw),
  update: Endpoint9_3(raw),
  remove: Endpoint9_4(raw),
  link: Endpoint9_5(raw),
  unlink: Endpoint9_6(raw),
  resolve: Endpoint9_7(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  globalCredentials: adaptGroup9(raw["server.global-credential"]),
